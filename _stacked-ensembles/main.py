...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='MeanStackedEnsembleAdultCensus')
    parser.add_argument('--optimizer_name', type=str, default='AdamW')
    parser.add_argument('--scheduler_name', type=str, default='OneCycleLR')
    parser.add_argument('--dataset_name', type=str, default='AdultCensus')
    parser.add_argument('--outf', type=str, default='checkpoints')
    parser.add_argument('--checkpoint', type=str, default='best.pth')
    parser.add_argument('--mode', type=str, default='test')
    parser.add_argument('--n_threads', type=int, default=0, help='Rule of thumb is 4*GPU_AVAIL')
    parser.add_argument('--resume', type=bool, default=True)
    parser.add_argument('--task', type=str, default='adult_census')
    parser.add_argument('--run_id', type=int, default=0)
    parser.add_argument('--criterion', type=str, default='BCEWithLogitsLoss')
    opts = parser.parse_args()

    opts.checkpoints_dir = join_path(opts.outf, opts.dataset_name, opts.model_name, opts.criterion, opts.scheduler_name)
